...
| Timeframe | What it holds |
|---|---|
| The yearly goal | The one clear outcome you want by December |
| Quarterly checkpoints | Four progress markers to confirm you're on pace |
| Monthly steps | One concrete action per month that moves you forward |
| This week's task | The single smallest next step you can do now |
