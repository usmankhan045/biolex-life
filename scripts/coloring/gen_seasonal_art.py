...
# ---------- catalogue ----------
COLORING=[
 ("christmas-mandala-coloring-page","Christmas Mandala","Biolex · Free Coloring Page",mandala_variant(V_CLASSIC),"A calming original Christmas mandala coloring page with layered petal and scallop rings. Print on letter paper and color it your way."),
 ("christmas-ornament-mandala-coloring-page","Ornament Mandala","Biolex · Christmas Coloring Page",mandala_variant(V_ORNAMENT),"An intricate ornament-style Christmas mandala coloring page for adults, with delicate scalloped and diamond detail."),
 ("snowflake-mandala-coloring-page","Snowflake Mandala","Biolex · Winter Coloring Page",mandala_variant(V_SNOW),"A crisp snowflake mandala coloring page built from stars and diamonds, a wintry design to color in."),
 ("star-mandala-coloring-page","Star Mandala","Biolex · Free Coloring Page",mandala_variant(V_STAR),"A bold star-burst mandala coloring page with pointed petals, festive for Christmas or a New Year."),
 ("halloween-mandala-coloring-page","Halloween Mandala","Biolex · Halloween Coloring Page",mandala_variant(V_STAR),"A spooky-season Halloween mandala coloring page with sharp star petals, original line art to color."),
 ("spiderweb-mandala-coloring-page","Spiderweb","Biolex · Halloween Coloring Page",spiderweb(7,12),"A symmetrical spiderweb coloring page for Halloween, concentric webs and radial spokes to color in."),
 ("new-year-mandala-coloring-page","New Year Mandala","Biolex · Free Coloring Page",mandala_variant(V_CLASSIC),"A fresh-start New Year mandala coloring page, a mindful way to welcome the new year."),
]
WALLART=[
