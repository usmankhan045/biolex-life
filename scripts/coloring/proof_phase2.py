...
</style></head><body><div class="page">{frame}{inner}<div class="foot">Paper Posy · Free Printable</div></div></body></html>'''
    return (html, desc)

# ---------- emit ----------
COLORING={"floral-mandala-coloring-page":("Floral Mandala","Paper Posy · Free Coloring Page",floral_mandala()),
          "butterfly-coloring-page":("Butterfly","Paper Posy · Free Coloring Page",butterfly())}
