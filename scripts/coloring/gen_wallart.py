...
def joy():
 ...
 <div class="foot">Paper Posy · Free Printable</div>'''
 return page(inner)
...
def merry():
 ...
 </div><div class="foot">Paper Posy · Free Printable</div>'''
 return page(inner)
...
def snow():
 ...
 </div><div class="foot" style="color:#8AA6C0">Paper Posy · Free Printable</div>'''
...
def gather():
 ...
 </div><div class="foot" style="color:#B98F76">Paper Posy · Free Printable</div>'''
...
def believe():
 ...
 </div><div class="foot" style="color:#8B7CBE">Paper Posy · Free Printable</div>'''
